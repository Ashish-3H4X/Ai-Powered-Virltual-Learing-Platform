...
'></div> */}
<img src={home}  className='object-cover  md:object-fill w-[100%] lg:h-[100%] h-[50vh] bg-gray-700 bg-gradient-to-br from-orange-500/10 to-yellow-400/10"
'/>
  <span className=' lg:text-[40px] absolute  md:text-[30px] lg:top-[10%] md:mt-[13px] top-[15%] w-[100%] flex items-center justify-center text-white font-bold  text-[17px] '>Learn from experts, Gain real-world skills</span>
  <span className=' lg:text-[40px] absolute   md:text-[30px] lg:top-[14%] md:pt-[32px] top-[20%] w-[100%] flex items-center justify-center text-white font-bold  text-[17px]'> “Start today. Lead tomorrow.”</span>
       <div className='absolute lg:top-[30%] top-[75%] md:top-[80%] w-[100%] flex items-center justify-center  gap-3 flex-wrap '>
        <button className="px-6 py-2 border-2 border-black  lg:border-white lg:text-white text-black text-[18px] font-medium rounded-xl flex items-center gap-2 cursor-pointer transition-all duration-300 hover:bg-black hover:text-white lg:hover:bg-white lg:hover:text-black shadow-md hover:shadow-xl"> View All Courses <TbPlayerPlayFilled /> </button>
