      ...
      <div className="w-[100%] min-h-screen p-4 sm:p-6   bg-gray-100">
        ...
        <div className="hidden md:block bg-white rounded-xl shadow p-4 overflow-x-auto">
          <table className="min-w-full text-sm  ">
            ...
            <tbody>
              <tr className="border-b hover:bg-gray-300 transition duration-200">
                ...
                <td className="px-[30px]  py-3 font-semibold  ">
                  <FaEdit className=" text-gray-600 hover:text-blue-600 cursor-pointer duration-300" />{" "}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        {/* for small screen  */}
          ...
          <div className="md:hidden space-y-4">
            ...
            <div className="bg-white rounded-lg shadow p-4 flex flex-col gap-3 ">
              ...
              <span className=' w-fit px-3 py-1 text-xs rounded-full bg-red-100'>
                Draft
              </span>
            </div>
